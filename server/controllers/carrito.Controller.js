...
clienteController.agregar_carrito_cliente = async function(req,res){
    if (req.user) {
        let data = req.body;
...
clienteController.obtener_carrito_cliente = async function(req,res){
    if (req.user) {
...
clienteController.eliminar_carrito_cliente = async function(req,res){
    if (req.user) {
        let id = req.params['id'];
